"""
Legacy PvP Snake Game Implementation

This file contains the original single-snake implementation for backward compatibility.
For new PvP features, use the modular structure in game/, ai/, train/, and test/ directories.
"""
...
if __name__ == "__main__":
    print("⚠️  DEPRECATED: This is the legacy single-snake implementation.")
    print("For new PvP features, use the modular structure:")
    print("  - Training: python train.py")
    print("  - Testing: python test.py")
