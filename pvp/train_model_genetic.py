"""
Legacy Training Script for PvP Snake AI

This file is kept for backward compatibility.
For new PvP features, use the modular structure: train/train_pvp.py
"""
...
def main():
    print("⚠️  DEPRECATED: This is the legacy training script.")
    print("For new PvP features, use: python train.py")
    print("=" * 60)
