...
**Files:** `snake_game_ray.py`, `train_model_ray.py`, `visualization.py`
...
**Files:** `snake_game_pixel.py`, `train_model_pixel.py`, `test_model.py`
...
**Files:** `snake_game_genetic.py`, `train_model_genetic.py`, `test_genetic.py`
...
**Files:** `game/snake_game_pvp.py`, `train/train_pvp.py`, `test/test_pvp.py`, `README.md`
